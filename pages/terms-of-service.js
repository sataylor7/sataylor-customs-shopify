    ...
    <div>
      ...
      <div className='max-w-2xl mx-auto px-4 py-8 sm:px-6 lg:max-w-7xl lg:px-8 gap-y-4 flex flex-col'>
        ...
        <p>
          ...
          accurate. <br /> We reserve the right, but are not obligated, to limit
        ...
        <p>
          ...
          provided by the relevant third-party provider(s). <br /> We may also,
        ...
        <p>
          ...
          will be uninterrupted, timely, secure or error-free. <br /> We do not
          warrant that the results that may be obtained from the use of the
          Service will be accurate or reliable. <br /> You agree that from time
          to time we may remove the Service for indefinite periods of time or
          cancel the Service at any time, without notice to you. <br /> You
        ...
        <p>
          In no case shall SATaylor Customs, our directors, officers, employees,
        ...
        <p>
          ...
          provision. <br /> These Terms of Service and any policies or operating
