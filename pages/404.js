      ...
      <div class='container flex items-center justify-center min-h-screen px-6 py-12 mx-auto'>
        <div class='w-full '>
          <div class='flex flex-col items-center max-w-lg mx-auto text-center'>
            <p class='text-sm font-medium text-sky-700'>404 error</p>
            ...
            <div class='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
              ...
              <button class='w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-sky-700 rounded-lg shrink-0 sm:w-auto hover:bg-sky-800 '>
                Take me home
              </button>
            </div>
          </div>
