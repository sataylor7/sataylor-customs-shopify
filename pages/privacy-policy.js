...
export default function PrivacyPolicy() {
  return (
    <div className='max-w-2xl mx-auto px-4 py-8 sm:px-6 lg:max-w-7xl lg:px-8 gap-y-3 flex flex-col'>
      <p className='text-xl p-4 bg-slate-100'>
        This Privacy Policy describes how www.sataylorcustoms.com (the “Site” or
        “we”) collects, uses, and discloses your Personal Information when you
        visit or make a purchase from the Site.
      </p>
      <h1 className='text-2xl font-semibold border-b-[1px] border-slate-100 pb-2 mb-2'>
        Contact
      </h1>
      <p>
      ...
      <h2 className='text-xl font-semibold border-b-[1px] border-slate-100 pb-2 my-4'>
      ...
      <p>
        <i>
          [Be sure to check this list against Shopify’s current list of cookies
          on the merchant storefront:{' '}
      ...
      <h3 className='text-l font-semibold pb-2 mb-2'>
      ...
      <p>
        ...
        the “Behavioral Advertising” section above.
      </p>
      <h2 className='text-xl font-semibold border-b-[1px] border-slate-100 pb-2 my-4'>
        Do Not Track
      </h2>
